...
class SpecAugment(nn.Module):
    ...
    def forward(self, samples, lengths, output_dict=False, **kargs):
        ...
        if self.training:
            ...
            for b in range(samples.size(0)):
                ...
                for _ in range(self.mT):
                    samples[b, :, :lengths[b]] = torchaudio.transforms.TimeMasking(time_mask_param=T).forward(samples[b, :, :lengths[b]])
